        ...
        <div class="to">
            <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                <div class="form-body" style="padding: 0; margin: 100px 0px 0px 700px;">
                    ...
                    <input type="text" name="hotenkh" id="hotenkh" value="<?php if(isset($_POST['hotenkh'])) echo $_POST['hotenkh']; ?>" placeholder="Họ và tên">
                    ...
                    <label style="margin-left: -230px;">Số fax: </label>
                    <input type="text" name="sofax" value="<?php if(isset($_POST['sofax'])) echo $_POST['sofax']; ?>" placeholder="Số fax">
